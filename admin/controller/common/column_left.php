...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$pro_report[] = array(
					'name'	   => $this->language->get('text_report_dashboard'),
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$pro_report[] = array(
					'name'	   => $this->language->get('text_report_setting'),
					'href'     => $this->url->link('extension/module/reports/report_setting', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$order_roport[] = array(
					'name'	   => $this->language->get('text_complet_order'),
					'href'     => $this->url->link('extension/module/reports/order', 'user_token=' . $this->session->data['user_token']. '&filter_order_status_id=5', true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$order_roport[] = array(
					'name'	   => $this->language->get('text_pending_order'),
					'href'     => $this->url->link('extension/module/reports/order', 'user_token=' . $this->session->data['user_token']. '&filter_order_status_id=1', true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$order_roport[] = array(
					'name'	   => $this->language->get('text_refunded_order'),
					'href'     => $this->url->link('extension/module/reports/order', 'user_token=' . $this->session->data['user_token'] . '&filter_order_status_id=11', true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$order_roport[] = array(
					'name'	   => $this->language->get('text_canceled_order'),
					'href'     => $this->url->link('extension/module/reports/order', 'user_token=' . $this->session->data['user_token']. '&filter_order_status_id=7', true),
					'children' => array()
				);
			}
			...
			if ($order_roport) {
				$pro_report[] = array(
					'name'	   => $this->language->get('text_order_reports'),
					'href'     => '',
					'children' => $order_roport
				);
			}
			//product report
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$product_report[] = array(
					'name'	   => $this->language->get('text_outofstock_product'),
					'href'     => $this->url->link('extension/module/reports/product', 'user_token=' . $this->session->data['user_token']. '&filter_stock_status_id=5', true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$product_report[] = array(
					'name'	   => $this->language->get('text_highestselling_product'),
					'href'     => $this->url->link('extension/module/reports/highestSellingProduct', 'user_token=' . $this->session->data['user_token']. '&filter_order_status_id=7', true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$product_report[] = array(
					'name'	   => $this->language->get('text_lowestselling_product'),
					'href'     => $this->url->link('extension/module/reports/lowestSellingProduct', 'user_token=' . $this->session->data['user_token']. '&filter_order_status_id=7', true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$product_report[] = array(
					'name'	   => $this->language->get('text_topview_product'),
					'href'     => $this->url->link('extension/module/reports/topViewProduct', 'user_token=' . $this->session->data['user_token']. '&filter_order_status_id=7', true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/reports')) {
				$product_report[] = array(
					'name'	   => $this->language->get('text_lowestview_product'),
					'href'     => $this->url->link('extension/module/reports/lowestViewProduct', 'user_token=' . $this->session->data['user_token']. '&filter_order_status_id=7', true),
					'children' => array()
				);
			}
			...
			if ($product_report) {
				$pro_report[] = array(
					'name'	   => $this->language->get('text_product_reports'),
					'href'     => '',
					'children' => $product_report
				);
			}
			...
			if ($pro_report) {
				$data['menus'][] = array(
					'id'       => 'menu-report',
					'icon'	   => 'fa-bar-chart',
					'name'	   => $this->language->get('text_pro_reports'),
					'href'     => '',
					'children' => $pro_report
				);
			}
